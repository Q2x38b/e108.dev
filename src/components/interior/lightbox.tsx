/* eslint-disable react-refresh/only-export-components, react-hooks/set-state-in-effect, react-hooks/refs -- vendored from interior.dev; exports its hook beside the component and mirrors callbacks into refs during render by design */
// Zoomable image lightbox, from interior.dev (lightbox). Adapted for this
// site: framer-motion imports, chrome coloured from the site's tokens, and a
// z-index above the page's fixed bottom blur.
import {
  useCallback,
  useEffect,
  useId,
...
const CHROME_BUTTON =
  "grid size-8 place-items-center rounded-[9px] border outline-none transition-[border-color,color,box-shadow] duration-150 focus-visible:border-[#4568FF] focus-visible:shadow-[0_1px_2px_rgba(28,25,23,0.08),0_10px_20px_-14px_rgba(69,104,255,0.6)]";
